...
public class Gis02Activity extends Activity {
	    ...
	    public void onCreate(Bundle savedInstanceState) {
			...
			ArcGISDynamicMapServiceLayer Road=new ArcGISDynamicMapServiceLayer("http://10.5.84.254:6080/arcgis/rest/services/L_814_102100/MapServer");
							...
							public void run() {
								...
								rp.setOutSpatialReference(mapSR);
								  RoutingTask rt = new RoutingTask( 
						                  "http://10.5.84.254:6080/arcgis/rest/services/L_814_4326/NAServer/%E8%B7%AF%E5%BE%84",
						                  null);
								  try {
									  //执行操作
	    ...
	    */
	    class MyRun implements Runnable{
			...
			public void run() {
					...
					tv_label.setText("长度："+r.getTotalLength()+"米，路线为："+r.getRouteName());
