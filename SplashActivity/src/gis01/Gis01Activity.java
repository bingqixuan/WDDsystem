...
public class Gis01Activity extends Activity {
	...
	private String URL="http://10.5.84.254:6080/arcgis/rest/services/test2/MapServer";
    ...
    class btnQueryListener implements OnClickListener{
		...
		public void onClick(View v) {
			...
			new AsyncQueryAttributeTask().execute("http://10.5.84.254:6080/arcgis/rest/services/test2/MapServer/3",condition);
		}
	}
  //从gis01跳到gis02  
